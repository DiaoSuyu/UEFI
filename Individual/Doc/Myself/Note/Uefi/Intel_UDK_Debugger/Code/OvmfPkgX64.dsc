...
[Defines]
  ...
  DEFINE SOURCE_DEBUG_ENABLE     = TRUE   # For Debugging at the source code level in the UDK
...
[PcdsFixedAtBuild]
  ...
  # Move this Pcd from [PcdsDynamicDefault] to [PcdsFixedAtBuild] for Debugging at the source code level in the UDK
