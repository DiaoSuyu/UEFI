...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x82c7eed5, 0x6ade, 0x4a5d, {0xb0, 0xd1, 0xcc, 0x62, 0x62, 0xcc, 0x3f, 0x5a}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HIIDebug";
