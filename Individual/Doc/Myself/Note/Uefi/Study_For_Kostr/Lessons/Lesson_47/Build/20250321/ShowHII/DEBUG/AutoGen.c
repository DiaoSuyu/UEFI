...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x5cbbf821, 0x7080, 0x44ac, {0x90, 0xcf, 0x31, 0x98, 0x72, 0xe7, 0x32, 0x00}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ShowHII";
