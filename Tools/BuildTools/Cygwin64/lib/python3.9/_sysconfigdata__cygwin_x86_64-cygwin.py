...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '',
 'CONFIGURE_CFLAGS_NODIST': '-ggdb -O2 -pipe -Wall -Werror=format-security '
                            '-Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong '
                            '--param=ssp-buffer-size=4 '
                            '-fdebug-prefix-map=/pub/devel/python/python39/python39-3.9.10-1.x86_64/build=/usr/src/debug/python39-3.9.10-1 '
                            '-fdebug-prefix-map=/pub/devel/python/python39/python39-3.9.10-1.x86_64/src/Python-3.9.10=/usr/src/debug/python39-3.9.10-1 '
                            '-DOPENSSL_NO_SSL3=1 -I/usr/include/uuid/ -std=c99 '
 ...
 'CONFIG_ARGS': "'--srcdir=/pub/devel/python/python39/python39-3.9.10-1.x86_64/src/Python-3.9.10' "
                "'--prefix=/usr' '--exec-prefix=/usr' '--localstatedir=/var' "
                "'--sysconfdir=/etc' '--infodir=/usr/share/info' "
                "'--mandir=/usr/share/man' '-C' '--enable-shared' "
                "'--enable-ipv6' '--with-libc=' '--with-libm=' "
                "'--with-system-expat' '--with-system-ffi' "
                "'--without-ensurepip' "
                "'ac_cv_func_bind_textdomain_codeset=yes' 'CC=gcc' 'CFLAGS=' "
                "'LDFLAGS=' 'LIBS=' 'CPPFLAGS='",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.9',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/pub/devel/python/python39/python39-3.9.10-1.x86_64/build/coverage.info',
 'COVERAGE_REPORT': '/pub/devel/python/python39/python39-3.9.10-1.x86_64/build/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             '-I/pub/devel/python/python39/python39-3.9.10-1.x86_64/src/Python-3.9.10/Include',
 'CXX': 'g++',
 ...
 'LIBPL': '/usr/lib/python3.9/config-3.9-x86_64-cygwin',
 ...
 'MAKESETUP': '/pub/devel/python/python39/python39-3.9.10-1.x86_64/src/Python-3.9.10/Modules/makesetup',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g '
                             ...
                             '-Wstrict-prototypes '
                             '-Werror=implicit-function-declaration '
                             '-fvisibility=hidden -ggdb -O2 -pipe -Wall '
                             '-Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 '
                             '-fstack-protector-strong '
                             '--param=ssp-buffer-size=4 '
                             '-fdebug-prefix-map=/pub/devel/python/python39/python39-3.9.10-1.x86_64/build=/usr/src/debug/python39-3.9.10-1 '
                             '-fdebug-prefix-map=/pub/devel/python/python39/python39-3.9.10-1.x86_64/src/Python-3.9.10=/usr/src/debug/python39-3.9.10-1 '
                             '-DOPENSSL_NO_SSL3=1 -I/usr/include/uuid/ '
                             '-I/pub/devel/python/python39/python39-3.9.10-1.x86_64/src/Python-3.9.10/Include/internal '
                             '-IObjects -IInclude -IPython -I. '
                             '-I/pub/devel/python/python39/python39-3.9.10-1.x86_64/src/Python-3.9.10/Include '
                             '-DPy_BUILD_CORE_BUILTIN',
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall',
 'PY_CFLAGS_NODIST': '-ggdb -O2 -pipe -Wall -Werror=format-security '
                     '-Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong '
                     '--param=ssp-buffer-size=4 '
                     '-fdebug-prefix-map=/pub/devel/python/python39/python39-3.9.10-1.x86_64/build=/usr/src/debug/python39-3.9.10-1 '
                     '-fdebug-prefix-map=/pub/devel/python/python39/python39-3.9.10-1.x86_64/src/Python-3.9.10=/usr/src/debug/python39-3.9.10-1 '
 ...
 'SIZEOF_WCHAR_T': 2,
 'SIZEOF__BOOL': 1,
 'SOABI': 'cpython-39-x86_64-cygwin',
 'SRCDIRS': 'Parser Parser/pegen Objects Python Modules Modules/_io Programs',
 'SRC_GDB_HOOKS': '/pub/devel/python/python39/python39-3.9.10-1.x86_64/src/Python-3.9.10/Tools/gdb/libpython.py',
 'STDC_HEADERS': 1,
 ...
 'TESTRUNNER': './python.exe '
               '/pub/devel/python/python39/python39-3.9.10-1.x86_64/src/Python-3.9.10/Tools/scripts/run_tests.py',
 'TESTTIMEOUT': 1200,
 'TIMEMODULE_LIB': 0,
 ...
 'UPDATE_FILE': 'python3.9 '
                '/pub/devel/python/python39/python39-3.9.10-1.x86_64/src/Python-3.9.10/Tools/scripts/update_file.py',
 'USE_COMPUTED_GOTOS': 0,
 'VERSION': '3.9',
 'VPATH': '/pub/devel/python/python39/python39-3.9.10-1.x86_64/src/Python-3.9.10',
 'WINDOW_HAS_FLAGS': 0,
 ...
 'abs_builddir': '/pub/devel/python/python39/python39-3.9.10-1.x86_64/build',
 'abs_srcdir': '/pub/devel/python/python39/python39-3.9.10-1.x86_64/src/Python-3.9.10',
 'datarootdir': '/usr/share',
 'exec_prefix': '/usr',
 'prefix': '/usr',
 'srcdir': '/pub/devel/python/python39/python39-3.9.10-1.x86_64/src/Python-3.9.10'}
